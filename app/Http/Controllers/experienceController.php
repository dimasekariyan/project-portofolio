...
class experienceController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $request->validate([
            ...
            'isi.required' => 'Kolom isian wajib diisi',
        ]);
        ...
        return redirect () -> route('experience.index')->with('success', 'Berhasil Menambahkah Data');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('experience.index')->with('success', 'Anda Berhasil Menghapus Data Pengalaman');
    }
}
