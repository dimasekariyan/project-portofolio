...
class profileController extends Controller
{
    ...
    function update(Request $request) {
            ...
            $request->validate([
                ...
                '_foto.mimes' => 'Format file yang diperbolehkan hanya .JPEG .JPG .PNG dan .GIF',
            ...
            return redirect()->route('profile.index')->with('success', 'Berhasil melakukan update data Profil Pengguna');
        }
