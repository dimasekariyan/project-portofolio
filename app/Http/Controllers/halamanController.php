...
class halamanController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect () -> route('halaman.index')->with('success', 'Berhasil Menambahkah Data');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('halaman.index')->with('success', 'Anda Berhasil Menghapus Data');
    }
}
